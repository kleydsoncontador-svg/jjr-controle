  ...
  "contas": [
    {
      ...
      "tipo": "'analitica' (conta de lançamento, código mais longo/específico, ex: 1.1.1.01.000001) ou 'sintetica' (conta de grupo/síntese, código curto, ex: '1', '1.1', '1.1.1' — soma as contas abaixo dela)",
...
Inclua TANTO as contas ANALÍTICAS (as de lançamento — código de classificação mais longo/específico, ex: "1.1.1.01.000001") QUANTO as contas SINTÉTICAS/de grupo (código mais curto, ex: "1", "1.1", "1.1.1" — Ativo, Ativo Circulante, Disponível...) que aparecerem na tabela do balancete, marcando cada uma com "tipo": "analitica" ou "sintetica" — o balancete/composição de saldos do usuário precisa da hierarquia completa, não só das contas de lançamento. NÃO inclua a linha de "Total Geral" (soma de tudo, não é uma conta nem sintética nem analítica) nem duplique uma mesma linha. Valores monetários sempre em número puro (sem "R$", sem separador de milhar, sem a letra D/C, com ponto decimal — ex: 61150.00 ou -61150.00).`;
